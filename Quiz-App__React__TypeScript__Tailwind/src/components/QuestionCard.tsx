  ...
  return (
    <div>
      ...
      <p
        ...
        className="bg-slate-300 dark:bg-slate-700 flex p-2 justify-between rounded-xl my-5"
        ...
        {answers.map(answer => (
          <div key={answer}>
            <button
              ...
              className="dark:bg-slate-600 bg-slate-400 w-full py-1 rounded-xl hover:bg-slate-500 dark:hover:bg-slate-700 focus:bg-slate-700 focus-visible:bg-slate-700 border-2 border-slate-400 dark:border-slate-600"
            >
