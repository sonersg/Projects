    ...
    <div className="bg-slate-300 dark:bg-slate-800 rounded-2xl px-6 py-8 ring-1 ring-slate-900/5 shadow-xl min-h-screen text-lg text-slate-800 dark:text-slate-100 text-center font-poppins">
      <div className="max-w-3xl mx-auto">
        ...
        number !== TOTAL_QUESTIONS - 1 ? (
          <button
            className="dark:bg-rose-700 bg-rose-200 hover:bg-rose-300 focus:bg-rose-300 focus-visible:bg-rose-300 p-2 px-5 dark:hover:bg-rose-900 dark:focus:bg-rose-900 dark:focus-visible:bg-rose-900 rounded-2xl my-5"
